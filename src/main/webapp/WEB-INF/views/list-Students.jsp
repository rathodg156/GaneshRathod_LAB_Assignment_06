...
<body>
	...
	<div class="container">
		...
		<form action="/StudentManagementSecure/students/search"
			class="form-inline">

			<!-- Add a button -->
			<a href="/StudentManagementSecure/students/showFormForAdd"
			...
			<a href="/StudentManagementSecure/logout"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/StudentManagementSecure/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a
							href="/StudentManagementSecure/students/delete?studentId=${tempStudent.id}"
